  ...
  render(){
    return (
      <div className="ritual-subjects">
        <div class="ritual-subjects__div main-pentagram"><img src="../assets/main-pentagram.png" alt="main-pentagram"></img></div>
        <div class="ritual-subjects__div"><img src="../assets/bafomet-head.png" alt="bafomet-head"></img></div>
        <div class="ritual-subjects__div bafomet-stamp">
        ...
        <div class="ritual-subjects__div pentacle">
        ...
        <div class="ritual-subjects__div right-pentacle">
