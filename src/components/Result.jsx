    ...
    if(this.props.ids.length === 4){
      return(
        <div className="cross-res">
          {this.generateOneCardResult(cards[ids[0] - 1].name, WaiteIMGs[ids[0] - 1].image, cards[ids[0] - 1].description, cards[ids[0] - 1].meaning, predictions[0], cards[ids[0] - 1].love.split('-').slicesplit('-').slice(1).join('-'), cards[this.props.ids[0] - 1].profession.split('-').slice(1).join('-'), cards[ids[0] - 1].generally.split('-').slice(1).join('-'))};
          {this.generateOneCardResult(cards[ids[1] - 1].name, WaiteIMGs[ids[1] - 1].image, cards[ids[1] - 1].description, cards[ids[1] - 1].proposal, predictions[4], cards[ids[1] - 1].love.split('-').slicesplit('-').slice(1).join('-'), cards[this.props.ids[1] - 1].profession.split('-').slice(1).join('-'), cards[ids[1] - 1].generally.split('-').slice(1).join('-'))};
          {this.generateOneCardResult(cards[ids[2] - 1].name, WaiteIMGs[ids[2] - 1].image, cards[ids[2] - 1].description, cards[ids[2] - 1].proposal, predictions[2], cards[ids[2] - 1].love.split('-').slicesplit('-').slice(1).join('-'), cards[this.props.ids[2] - 1].profession.split('-').slice(1).join('-'), cards[ids[2] - 1].generally.split('-').slice(1).join('-'))};
          {this.generateOneCardResult(cards[ids[3] - 1].name, WaiteIMGs[ids[3] - 1].image, cards[ids[3] - 1].description, cards[ids[3] - 1].perspectives, predictions[3], cards[ids[3] - 1].love.split('-').slicesplit('-').slice(1).join('-'), cards[this.props.ids[3] - 1].profession.split('-').slice(1).join('-'), cards[ids[3] - 1].generally.split('-').slice(1).join('-'))};
        </div>
      )
    }
  }
